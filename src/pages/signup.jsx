    ...
    return (
        <section>
            <div className="flex flex-wrap">
                <div className="pt-6 lg:pt-16 pb-6 w-full lg:w-1/2 bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-amber-200 via-violet-600 to-sky-900">
                    <div className="max-w-md mx-auto ">
                        <div className="mb-6 lg:mb-20 w-full px-3 flex items-center justify-between">
                            <a className="text-3xl font-bold leading-none" href="#">
                                <img className="h-12" src="atis-assets/logo/atis/atis-mono-black.svg" alt="" />
                            </a>
                            <a className="py-2 px-6 text-xs rounded-l-xl rounded-t-xl bg-green-100 hover:bg-green-200 text-green-600 font-bold transition duration-200" href="signin">
                                Sign In
                            </a>
                        </div>
                        <div>
                            ...
                            <form>
                                ...
                                <div className="mb-3 flex border p-4 mx-2 bg-gray-50 rounded">
                                    <input
                                        className="w-full text-xs bg-gray-50 outline-none"
                                        type="email"
                                        placeholder="example@skywalker.com"
                                    />
                                    <svg
                                ...
                                <div className="px-3 text-center">
                                    <button className="mb-2 w-full hover:shadow-2xl py-4 bg-gradient-to-r from-yellow-200 via-pink-200 to-pink-400 hover:bg-gray-700 rounded text-sm font-bold text-gray-900 transition duration-200">
                                        Sign Up
                                    </button>
                                    <span className="text-gray-900 text-xs">
                                        <span>Already have an account?</span>
                                        <a className="text-white ml-5 hover:underline" href="signin">
                                            Sign In
                                        </a>
                                    </span>
                                    <p className="mt-16 text-xs text-gray-900">
                ...
                <div className="lg:hidden bg-black w-full">
                    ...
                    <div className="py-10 px-3 text-center" style={{ zIndex: 10 }}>
                        ...
                        <a className="py-2 px-6 rounded-t-xl rounded-l-xl bg-gradient-to-r from-yellow-200 via-pink-200 to-pink-400 hover:bg-gray-500 text-gray-500 hover:text-gray-700 transition duration-200 font-bold" href="#">
                            Get Started
                        </a>
                    </div>
                </div>
